...
export function Payments() {
    ...
    const pieData = stats?.distribution ? [
        { name: 'Sessions', value: stats.distribution.sessionCommissions || 0, color: '#4318FF' },
        { name: 'Premium', value: stats.distribution.premiumSubscriptions || 0, color: '#312E81' },
        { name: 'Retreats', value: stats.distribution.retreatPlatformFees || 0, color: '#6AD2FF' },
    ] : [
    ...
    return (
        <Tabs.Root value={activeTab} onValueChange={setActiveTab} className="space-y-6 pb-10" onClick={() => setIsDropdownOpen(false)}>
            ...
            <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-6 pt-4">
                ...
                <Tabs.List className="flex items-center bg-white dark:bg-white/5 p-1.5 rounded-full border border-[#E9EDF7] dark:border-white/10 shadow-sm">
                    {[
            ...
            <Tabs.Content value="revenue" className="space-y-6 animate-in fade-in duration-500">
                {/* Performance Bar */}
                ...
                <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <StatsCard
                        ...
                        trend={stats?.netPlatformRevenue >= 0 ? "up" : "down"}
                    />
                    <StatsCard
                                ...
                                <div key={item.name} className="space-y-2">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-[10px] font-black text-[#1b254b] dark:text-white">
                                            {item.value ? ((item.value / stats?.totalPlatformRevenue) * 100 || 0).toFixed(1) : "0.0"}%
                                        </span>
                                    </div>
                                    <div className="h-1.5 w-full bg-[#F4F7FE] dark:bg-white/5 rounded-full overflow-hidden">
                                        <div
                                            ...
                                            style={{
                                                width: `${item.value ? (item.value / stats?.totalPlatformRevenue) * 100 : 0}%`,
