    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h2 className="text-3xl font-extrabold tracking-tight text-[#1b254b] dark:text-white">Payments Center</h2>
                ...
                <div className="flex items-center gap-3">
                    <div className="flex items-center bg-white dark:bg-[#111C44] rounded-full px-4 py-2 border border-[#E9EDF7] dark:border-white/5 shadow-sm">
                        ...
                        <span className="text-sm font-bold text-[#1b254b] dark:text-white">Current Quarter</span>
                    </div>
                </div>
            </div>

            <Tabs.Root defaultValue="overview" className="space-y-6">
                <Tabs.List className="flex items-center bg-white dark:bg-white/5 p-1 rounded-2xl w-fit shadow-sm border border-transparent dark:border-white/5">
                    <Tabs.Trigger 
                        value="overview"
                        className="flex items-center gap-2 px-6 py-2.5 text-sm font-bold text-[#A3AED0] data-[state=active]:text-[#4318FF] data-[state=active]:bg-[#F4F7FE] dark:data-[state=active]:bg-white/10 dark:data-[state=active]:text-white transition-all rounded-xl"
                    >
                ...
                <Tabs.Content value="overview" className="space-y-6 animate-in fade-in slide-in-from-bottom-3 duration-500">
                    {/* Quick Stats Grid */}
                                ...
                                <ResponsiveContainer width="100%" height="100%">
                                    <BarChart data={distributionData} margin={{ top: 20, right: 30, left: 0, bottom: 0 }}>
                                        <XAxis 
                                            ...
                                            axisLine={false} 
                                            tickLine={false} 
                                            tick={{ fill: '#A3AED0', fontSize: 10, fontStyle: 600 }}
                                        />
                                        <Tooltip 
                ...
                <Tabs.Content value="reports" className="animate-in fade-in slide-in-from-bottom-3 duration-500">
                    <CommissionTable />
                </Tabs.Content>
            </Tabs.Root>
        </div>
