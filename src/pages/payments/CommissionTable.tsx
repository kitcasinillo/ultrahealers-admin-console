            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                <div className="flex flex-wrap gap-3">
                    ...
                    <div className="relative">
                        ...
                        {isDateDropdownOpen && (
                            <div className="absolute left-0 mt-2 w-64 bg-white dark:bg-[#1b254b] rounded-2xl shadow-[0_20px_40px_0_rgba(11,20,55,0.15)] border border-[#E9EDF7] dark:border-white/5 py-3 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
