...
- **Interactive Chart Totals & Series Highlighting**:
  - Updated [`AnalyticsDashboard.tsx`](file:///C:/Users/ItechMediaLogic/prods/ultrahealers-admin-console/src/pages/reports/AnalyticsDashboard.tsx) & [`BaseAreaChart.tsx`](file:///C:/Users/ItechMediaLogic/prods/ultrahealers-admin-console/src/components/Charts/BaseAreaChart.tsx): converted **Seeker Signups** and **Healer Signups** stat badges at the bottom-right of the chart into interactive toggle buttons. Clicking **Seeker Signups** highlights the Seeker area trend (`strokeWidth: 3.5`, `strokeOpacity: 1`, `fillOpacity: 0.35`) while dimming the Healer trend (`strokeOpacity: 0.15`, `fillOpacity: 0.03`). Clicking again resets to showing both trends clearly.
- **Enhanced Group By Chart Filter Dropdown**:
  - Updated [`AnalyticsDashboard.tsx`](file:///C:/Users/ItechMediaLogic/prods/ultrahealers-admin-console/src/pages/reports/AnalyticsDashboard.tsx), [`BaseAreaChart.tsx`](file:///C:/Users/ItechMediaLogic/prods/ultrahealers-admin-console/src/components/Charts/BaseAreaChart.tsx), & [`analytics.ts`](file:///C:/Users/ItechMediaLogic/prods/ultrahealers-admin-console/src/api/analytics.ts): enhanced the `Group by:` filter in the User Acquisition Trends chart header into a stylized popover dropdown component featuring `Layers` icon, option descriptions (`Auto (Default)`, `Daily`, `Weekly`, `Monthly`), checkmark selection indicators, dark mode styling, and smooth enter animations.
- **Excluded Filter Buttons & Dropdowns from Click Interaction Tracking**:
  - Updated native analytics tracker [`uh-analytics.js`](file:///C:/Users/ItechMediaLogic/prods/ultrahealers-admin-console/public/uh-analytics.js) across `ultrahealers-admin-console`, `seeker-app`, and `healer-app`: added `isIgnoredControlClick` helper. Clicks on filter buttons (`Subdomain Filter`, `Date Horizon Popover`, `Group By Dropdown`, `Date Pickers`, `Option Selects`, `Select All`, `Reset Preset`, etc.) are suppressed on the client side before sending HTTP `collect` beacon requests.
  - Updated backend [`analyticsController.js`](file:///C:/Users/ItechMediaLogic/prods/backend-server/controllers/analyticsController.js): added `isFilterOrDropdownDescriptor` helper ensuring any legacy filter clicks are filtered out of click storage and Top Click Interactions metrics.
